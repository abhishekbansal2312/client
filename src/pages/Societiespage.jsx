// src/components/SocietiesPage.js
            ...
            <div className="min-h-screen bg-gray-900 text-white p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {societies.map(society => (
                        <div key={society.id} className="bg-gray-800 p-4 rounded-lg shadow-lg">
                            ...
                            <a href={`/society/${society.id}`} className="text-blue-400 hover:underline mt-4 block">
                                Learn More
                            </a>
                        </div>
                    ))}
